...
//контроллер
myApp.controller("uchetReportsFilterTovarovCtrl", function uchetReportsFilterTovarovCtrl($scope, $http) {
  ...
  $scope.$on("global.selectedUchetReportsSubMenuItemChanged", function selectedMenuItemChanged(event, newValue) {
    ...
    //возвращаемт список доступны для отчета специалистов
  ...
  $scope.refresh = function refresh() {
    ...
    $http({
      method: "GET",
      url: "/Home/GetUchetReportFilterTovarov",
      params: {
  ...
  $scope.btnClearFilterClick = function btnClearFilterClick() {
