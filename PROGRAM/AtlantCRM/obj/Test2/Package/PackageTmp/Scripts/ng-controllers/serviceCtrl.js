...
serviceCtrl = myApp.controller("serviceCtrl", function serviceCtrl($scope, $http) {
  ...
  $scope.saveService = function saveService() {
    ...
    var productPhoto = $scope.o_service[0].product_photo.substring($scope.o_service[0].product_photo.indexOf(",") + 1);
    var guaranteePhoto = $scope.o_service[0].guarantee_photo.substring($scope.o_service[0].guarantee_photo.indexOf(",") + 1);
    var checkPhoto = $scope.o_service[0].product_check.substring($scope.o_service[0].product_check.indexOf(",") + 1);
