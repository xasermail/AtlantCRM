...
-- Description:	Возвращет список пришедших на сеанс с телефонами
-- =============================================
if exists(select 1 from sys.procedures as a where a.name = 'GET_LIST_CAME') drop procedure dbo.GET_LIST_CAME;

GO

create procedure dbo.GET_LIST_CAME
	@m_org_id int,
	@d date
AS
BEGIN
